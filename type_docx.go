...
const (
	...
	DocxCodeLanguageCMake        DocxCodeLanguage = 68 // CMake
	DocxCodeLanguageDiff         DocxCodeLanguage = 69 // Diff
	DocxCodeLanguageGherkin      DocxCodeLanguage = 70 // Gherkin
	DocxCodeLanguageGraphQL      DocxCodeLanguage = 71 // GraphQL
	DocxCodeLanguageGLSL         DocxCodeLanguage = 72 // OpenGL Shading Language
	DocxCodeLanguageProperties   DocxCodeLanguage = 73 // Properties
	DocxCodeLanguageSolidity     DocxCodeLanguage = 74 // Solidity
	DocxCodeLanguageTOML         DocxCodeLanguage = 75 // TOML
)
