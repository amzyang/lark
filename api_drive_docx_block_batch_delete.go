...
type BatchDeleteDocxBlockReq struct {
	...
	StartIndex         int64   `json:"start_index"`                    // 删除的起始索引（操作区间左闭右开）, start_index 需要小于 end_index示例值: 0 最小值: `0`
	EndIndex           int64   `json:"end_index"`                      // 删除的末尾索引（操作区间左闭右开）, start_index 需要小于 end_index示例值: 1 最小值: `1`
}
