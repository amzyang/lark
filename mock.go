...
type Mock struct {
	...
	mockDriveCreateWhiteboardPlantUML                          func(ctx context.Context, request *CreateWhiteboardPlantUMLReq, options ...MethodOptionFunc) (*CreateWhiteboardPlantUMLResp, *Response, error)
	mockDriveConvertDocxBlock                                  func(ctx context.Context, request *ConvertDocxBlockReq, options ...MethodOptionFunc) (*ConvertDocxBlockResp, *Response, error)
	mockDriveDownloadWhiteboardImage                           func(ctx context.Context, request *DownloadWhiteboardImageReq, options ...MethodOptionFunc) (*DownloadWhiteboardImageResp, *Response, error)
	mockDriveBatchUpdateDocxBlock                              func(ctx context.Context, request *BatchUpdateDocxBlockReq, options ...MethodOptionFunc) (*BatchUpdateDocxBlockResp, *Response, error)
	mockDriveCreateDocxDescendant                              func(ctx context.Context, request *CreateDocxDescendantReq, options ...MethodOptionFunc) (*CreateDocxDescendantResp, *Response, error)
